...
attribute "nginx",
  :display_name => "Nginx",
  :description => "Hash of Nginx attributes",
  :type => "hash"
...
attribute "nginx/src_binary",
  :display_name => "Nginx Source Binary",
  :description => "Location of the nginx server source binary",
  :default => "/opt/local/nginx-0.8.53/sbin/nginx"
